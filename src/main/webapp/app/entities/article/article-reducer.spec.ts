...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './article.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ARTICLE_LIST actions', async () => {
    ...
    it('dispatches FETCH_ARTICLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ARTICLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ARTICLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ARTICLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ARTICLE actions', async () => {
      const expectedActions = [
        {
